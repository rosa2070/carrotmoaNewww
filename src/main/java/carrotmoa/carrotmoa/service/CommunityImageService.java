...
//    private final String localLocation = "C:\\Users\\user\\Desktop\\localfileupload\\";
//
...
//        // s3에 이미지 올리는 코드
//
//        s3Client.s3Client().putObject(new PutObjectRequest(bucket, uuidFileName, localFile).withCannedAcl(CannedAccessControlList.PublicRead));

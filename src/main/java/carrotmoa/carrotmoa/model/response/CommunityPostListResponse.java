...
public class CommunityPostListResponse {
    ...
    public CommunityPostListResponse(Post post, CommunityPost communityPost, CommunityCategory communityCategory, UserAddress userAddress, PostImage postImage, int commentCount) {

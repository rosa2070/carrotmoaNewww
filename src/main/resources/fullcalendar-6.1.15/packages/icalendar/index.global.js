...
FullCalendar.ICalendar = (function (exports, core, internal, ICAL) {
  ...
  class IcalExpander {
    constructor(opts) {
      this.maxIterations = opts.maxIterations != null ? opts.maxIterations
          : 1000;
      this.skipInvalidDates = opts.skipInvalidDates != null
          ? opts.skipInvalidDates : false;
      ...
      this.events = this.component.getAllSubcomponents('vevent').map(
          vevent => new ICAL__namespace.Event(vevent));
        ...
        if (event.isRecurring()) {
          ...
          do {
            ...
            if (next) {
              ...
              const exception = exceptions.find(ex => ex.uid === event.uid

...
FullCalendar.List = (function (exports, core, internal$1, preact) {
  ...
  class ListViewHeaderRow extends internal$1.BaseComponent {
    ...
    render() {
      ...
      let renderProps = Object.assign({
        ...
        text,
        sideText,
        navLinkAttrs: internal$1.buildNavLinkAttrs(this.context, dayDate),
  ...
  function renderInnerContent(props) {
    return (preact.createElement(preact.Fragment, null,
        props.text && (preact.createElement("a",
            Object.assign({id: props.textId, className: "fc-list-day-text"},
                props.navLinkAttrs), props.text)),
        props.sideText && ( /* not keyboard tabbable */preact.createElement("a",
  ...
  class ListViewEventRow extends internal$1.BaseComponent {
    render() {
      ...
      return (preact.createElement(internal$1.EventContainer,
          ...
          }), (InnerContent, eventContentArg) => (preact.createElement(
              preact.Fragment, null,
  ...
  function renderEventInnerContent(seg, context) {
    ...
    return (preact.createElement("a", Object.assign({}, interactiveAttrs),
  ...
  function buildTimeContent(seg, timeFormat, context, timeHeaderId,
    ...
    if (options.displayEventTime !== false) {
      ...
      if (eventDef.allDay) {
        ...
        if (seg.isStart) {
          timeText = internal$1.buildSegTimeText(seg, timeFormat, context, null,
              null, eventInstance.range.start, seg.end);
        } else if (seg.isEnd) {
          timeText = internal$1.buildSegTimeText(seg, timeFormat, context, null,
              null, seg.start, eventInstance.range.end);
        } else {
          doAllDay = true;
        }
      } else {
      ...
      return (preact.createElement("td", {className: "fc-list-event-time"},
          timeText));
    }
    return null;
  }
  ...
  class ListView extends internal$1.DateComponent {
    ...
    render() {
      ...
      return (preact.createElement(internal$1.ViewContainer, {
          ...
          preact.createElement(internal$1.Scroller, {
          ...
          (nowDate, todayRange) => {
            ...
            for (let dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
              ...
              if (daySegs) { // sparse array, so might be undefined
                ...
                // append a day header
                innerNodes.push(preact.createElement(ListViewHeaderRow, {
                  key: dayStr,
                  cellId: dateHeaderId,
                ...
                for (let seg of daySegs) {
                  innerNodes.push(preact.createElement(ListViewEventRow,
                      Object.assign({
                        key: dayStr + ':'
            ...
            return (preact.createElement("table",
                ...
                preact.createElement("thead", null,
                    preact.createElement("tr", null,
                        preact.createElement("th",
                            {scope: "col", id: timeHeaderId}, options.timeHint),
                        preact.createElement("th",
                            {scope: "col", "aria-hidden": true}),
                        preact.createElement("th",
    ...
    _eventStoreToSegs(eventStore, eventUiBases, dayRanges) {
      return this.eventRangesToSegs(
          internal$1.sliceEventStore(eventStore, eventUiBases,

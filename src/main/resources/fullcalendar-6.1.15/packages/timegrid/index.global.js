...
(c) 2024 Adam Shaw
*/
FullCalendar.TimeGrid = (function (exports, core, internal$1, preact,
    internal$2) {
  'use strict';
  ...
  function TimeColsAxisCell(props) {
    ...
    return (preact.createElement(internal$1.ViewContextType.Consumer, null,
        (context) => {
          if (!props.isLabeled) {
            return (preact.createElement("td", {
  ...
  class TimeBodyAxis extends internal$1.BaseComponent {
    render() {
      return this.props.slatMetas.map(
          (slatMeta) => (preact.createElement("tr", {key: slatMeta.key},
              preact.createElement(TimeColsAxisCell,
                  Object.assign({}, slatMeta)))));
    }
  }
  ...
  class TimeColsView extends internal$1.DateComponent {
    constructor() {
      ...
      this.renderHeadAxis = (rowKey, frameHeight = '') => {
        ...
        return (preact.createElement("th",
    ...
    renderSimpleLayout(headerRowContent, allDayContent, timeContent) {
      ...
      return (preact.createElement(internal$1.ViewContainer, {
            elRef: this.rootElRef,
            elClasses: ['fc-timegrid'],
            viewSpec: context.viewSpec
          },
          preact.createElement(internal$1.SimpleScrollGrid, {
    ...
    renderHScrollLayout(headerRowContent, allDayContent, timeContent, colCnt,
      ...
      let stickyHeaderDates = !props.forPrint
          && internal$1.getStickyHeaderDates(context.options);
      let stickyFooterScrollbar = !props.forPrint
          && internal$1.getStickyFooterScrollbar(context.options);
      let sections = [];
      if (headerRowContent) {
        sections.push({
          type: 'header',
          ...
          chunks: [
            {
              key: 'axis',
              rowContent: (arg) => (preact.createElement("tr",
                  {role: "presentation"},
      ...
      if (allDayContent) {
        sections.push({
          ...
          chunks: [
            {
              key: 'axis',
              rowContent: (contentArg) => (preact.createElement("tr",
                  {role: "presentation"},
                ...
                preact.createElement("div",
                    ...
                    preact.createElement("table", {
                        ...
                        preact.createElement("tbody", null,
                            preact.createElement(TimeBodyAxis,
                                {slatMetas: slatMetas}))),
                    preact.createElement("div",
                        ...
                        preact.createElement(internal$1.NowTimer, {
                          ...
                          if (typeof nowIndicatorTop === 'number') {
                            return (preact.createElement(
                                internal$1.NowIndicatorContainer, {
  ...
  class TimeColsSlatsCoords {
    ...
    computeDateTop(when, startOfDayDate) {
      ...
      return this.computeTimeTop(
          internal$1.createDuration(when.valueOf() - startOfDayDate.valueOf()));
    }
    ...
    computeTimeTop(duration) {
      ...
      let slatCoverage = (duration.milliseconds - internal$1.asRoughMs(
          dateProfile.slotMinTime)) / internal$1.asRoughMs(this.slotDuration);
      let slatIndex;
      let slatRemainder;
      ...
      return (preact.createElement("tbody", null,
          props.slatMetas.map((slatMeta, i) => {
            ...
            return (preact.createElement("tr",
                ...
                props.axis && (preact.createElement(TimeColsAxisCell,
                    Object.assign({}, slatMeta))),
                preact.createElement(internal$1.ContentContainer, {
                  elTag: "td",
                  elClasses: [
  ...
  */
    ...
    render() {
      ...
      return (preact.createElement("div",
          ...
          preact.createElement("table", {
              ...
              preact.createElement(TimeColsSlatsBody, {
      ...
      if (props.onCoords &&
        ...
        if (rootEl.offsetHeight) { // not hidden by css
          props.onCoords(new TimeColsSlatsCoords(
              new internal$1.PositionCache(this.rootElRef.current,
  ...
  function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
    ...
    for (; level < levelCnt; level += 1) {
      ...
      let entry;
      let searchIndex = internal$1.binarySearch(entries,
          subjectEntry.span.start, internal$1.getEntrySpanEnd);
  ...
  function stretchWeb(topLevelNodes, totalThickness) {
    const stretchNode = cacheable(
        (node, startCoord, prevThickness) => internal$1.buildEntryKey(node),
  ...
  function webToRects(topLevelNodes) {
    ...
    const processNode = cacheable(
        (node, levelCoord, stackDepth) => internal$1.buildEntryKey(node),
  ...
  class TimeColEvent extends internal$1.BaseComponent {
    render() {
      return (preact.createElement(internal$1.StandardEvent,
  ...
  class TimeCol extends internal$1.BaseComponent {
    ...
    render() {
      ...
      return (preact.createElement(internal$1.DayCellContainer, {
        ...
        extraRenderProps: props.extraRenderProps
          ...
          preact.createElement("div", {className: "fc-timegrid-col-events"},
          ...
          internal$1.hasCustomDayCellContent(options) && (preact.createElement(
              InnerContent,
      ...
      return (preact.createElement(preact.Fragment, null,
          ...
          segPlacements.map((segPlacement) => {
            ...
            return (preact.createElement("div", {
                ...
                preact.createElement(TimeColEvent, Object.assign({
                  seg: seg,
                  ...
                  isShort: isShort
                }, internal$1.getSegMeta(seg, todayRange, nowDate)))));
          })));
    }
    ...
    renderHiddenGroups(hiddenGroups, segs) {
      ...
      return (preact.createElement(preact.Fragment, null,
          hiddenGroups.map((hiddenGroup) => {
            ...
            return (preact.createElement(TimeColMoreLink, {
              key: internal$1.buildIsoString(
                  internal$1.computeEarliestSegStart(hiddenSegs)),
    ...
    renderFillSegs(segs, fillType) {
      ...
      let children = segVCoords.map((vcoords, i) => {
        let seg = segs[i];
        return (preact.createElement("div", {
          key: internal$1.buildEventRangeKey(seg.eventRange),
          className: "fc-timegrid-bg-harness",
          style: computeSegVStyle(vcoords)
        }, fillType === 'bg-event' ?
            preact.createElement(internal$1.BgEvent, Object.assign({seg: seg},
                internal$1.getSegMeta(seg, props.todayRange, props.nowDate))) :
    ...
    renderNowIndicator(segs) {
      ...
      return segs.map(
          (seg, i) => (preact.createElement(internal$1.NowIndicatorContainer
  ...
  class TimeColsContent extends internal$1.BaseComponent {
          ...
          preact.createElement("table", {
              ...
              preact.createElement("tbody", {role: "presentation"},
                  preact.createElement("tr", {role: "row"},
                      props.axis && (preact.createElement("td", {
                            "aria-hidden": true,
                      ...
                      props.cells.map(
                          (cell, i) => (preact.createElement(TimeCol, {
                            key: cell.key,
    ...
    updateCoords() {
      ...
      if (props.onColCoords &&
        ...
        props.onColCoords(new internal$1.PositionCache(this.rootElRef.current,
  ...
  class TimeCols extends internal$1.DateComponent {
    ...
    render() {
      ...
      return (preact.createElement("div", {
          ...
          preact.createElement(TimeColsSlats, {
            axis: props.axis,
            dateProfile: props.dateProfile,
            slatMetas: props.slatMetas,
          ...
          preact.createElement(TimeColsContent, {
            cells: props.cells,
            axis: props.axis,
            dateProfile: props.dateProfile,
    ...
    queryHit(positionLeft, positionTop) {
      ...
      if (colIndex != null && slatIndex != null) {
        ...
        let time = internal$1.addDurations(dateProfile.slotMinTime,
            internal$1.multiplyDuration(snapDuration, snapIndex));
  ...
  function processSlotOptions(slotDuration, snapDurationOverride) {
    ...
    let snapsPerSlot = internal$1.wholeDivideDurations(slotDuration,
        snapDuration);
  ...
  class DayTimeCols extends internal$1.DateComponent {
    ...
    render() {
      ...
      return (preact.createElement(internal$1.NowTimer,
          ...
          (nowDate, todayRange) => (preact.createElement(TimeCols,
  ...
  function buildSlatMetas(slotMinTime, slotMaxTime, explicitLabelInterval,
    ...
    while (internal$1.asRoughMs(slatTime) < internal$1.asRoughMs(slotMaxTime)) {
      ...
      let isLabeled = internal$1.wholeDivideDurations(slatIterator,
          labelInterval) !== null;
      metas.push({
        date,
        time: slatTime,
  ...
  function computeLabelInterval(slotDuration) {
    ...
    for (i = STOCK_SUB_DURATIONS.length - 1; i >= 0; i -= 1) {
      ...
      slotsPerLabel = internal$1.wholeDivideDurations(labelInterval,
          slotDuration);
  ...
  class DayTimeColsView extends TimeColsView {
    ...
    render() {
      ...
      let headerContent = options.dayHeaders && (preact.createElement(
          internal$1.DayHeader, {
            dates: dayTableModel.headerDates,
            dateProfile: dateProfile,
            datesRepDistinctDays: true,
            renderIntro: hasAttachedAxis ? this.renderHeadAxis : null
          }));
      let allDayContent = (options.allDaySlot !== false)
          && ((contentArg) => (preact.createElement(internal$2.DayTable,
              Object.assign({}, splitProps.allDay, {
                ...
                renderRowIntro: hasAttachedAxis ? this.renderTableRowAxis
                    : null,
      ...
      let timeGridContent = (contentArg) => (preact.createElement(DayTimeCols,
  ...
  function buildTimeColsModel(dateProfile, dateProfileGenerator) {
    let daySeries = new internal$1.DaySeriesModel(dateProfile.renderRange,
        dateProfileGenerator);

...
FullCalendar.Luxon = (function (exports, core, luxon, internal) {
  ...
  function toLuxonDuration(duration, calendar) {
    ...
    let {dateEnv} = calendar.getCurrentData();
    return luxon.Duration.fromObject(Object.assign(Object.assign({}, duration),
        {locale: dateEnv.locale.codes[0]}));
  }
  ...
  function formatWithCmdStr(cmdStr, arg) {
    ...
    if (arg.end) {
      let start = arrayToLuxon(arg.start.array, arg.timeZone,
          arg.localeCodes[0]);
      let end = arrayToLuxon(arg.end.array, arg.timeZone, arg.localeCodes[0]);
      return formatRange(cmd, start.toFormat.bind(start),
          end.toFormat.bind(end), arg.defaultSeparator);
    }
    return arrayToLuxon(arg.date.array, arg.timeZone,
        arg.localeCodes[0]).toFormat(cmd.whole);
  }

...
FullCalendar.Interaction = (function (exports, core, internal) {
  ...
  */
  class PointerDragging {
    ...
    tryStart(ev) {
      ...
      if (subjectEl &&
          (!this.handleSelector || internal.elementClosest(downEl,
              this.handleSelector))) {
  ...
  */
  class OffsetTracker {
    constructor(el) {
      ...
      this.scrollCaches = internal.getClippingParents(el).map(
  ...
  */
  class HitDragging {
    ...
    processFirstCoord(ev) {
      ...
      if (initialHit) {
        if (this.useSubjectCenter && subjectRect) {
          let slicedSubjectRect = internal.intersectRects(subjectRect,
              initialHit.rect);
    ...
    prepareHits() {
      this.offsetTrackers = internal.mapHash(this.droppableStore,
          (interactionSettings) => {
        ...
        if (offsetTracker && // wasn't destroyed mid-drag
          ...
          if (
            ...
            if (hit && (
                    ...
                    internal.rangeContainsRange(hit.dateProfile.activeRange,
                        hit.dateSpan.range)) &&
  ...
  class DateClicking extends internal.Interaction {
    constructor(settings) {
      ...
      let hitDragging = this.hitDragging = new HitDragging(this.dragging,
          internal.interactionSettingsToStore(settings));
  ...
  */
    ...
    constructor(settings) {
      ...
      this.handleHitUpdate = (hit, isFinal) => {
        ...
        if (hit) {
          ...
          if (!dragSelection || !internal.isDateSelectionValid(dragSelection,
      ...
      this.handlePointerUp = (pev) => {
        if (this.dragSelection) {
          ...
          internal.triggerDateSelect(this.dragSelection, pev,
  ...
  class EventDragging extends internal.Interaction {
    constructor(settings) {
      ...
      this.handlePointerDown = (ev) => {
        ...
        this.relevantEvents = internal.getRelevantEvents(
      ...
      this.handleDragStart = (ev) => {
        ...
        if (this.isDragging) {
          ...
          initialContext.emitter.trigger('eventDragStart', {
            el: this.subjectEl,
            event: new internal.EventImpl(initialContext, eventRange.def,
                eventRange.instance),
            jsEvent: ev.origEvent,
      ...
      this.handleHitUpdate = (hit, isFinal) => {
        ...
        if (hit) {
          ...
          if (initialContext === receivingContext ||
            ...
            if (mutation) {
              mutatedRelevantEvents = internal.applyMutationToEventStore(
                  relevantEvents,
                  receivingContext.getCurrentData().eventUiBases, mutation,
                  receivingContext);
              interaction.mutatedEvents = mutatedRelevantEvents;
              if (!internal.isInteractionValid(interaction, hit.dateProfile,
                  receivingContext)) {
                isInvalid = true;
                mutation = null;
      ...
      this.handleDragEnd = (ev) => {
        if (this.isDragging) {
          ...
          let eventApi = new internal.EventImpl(initialContext, eventDef,
              eventInstance);
          let relevantEvents = this.relevantEvents;
          ...
          if (validMutation) {
            ...
            if (receivingContext === initialContext) {
              let updatedEventApi = new internal.EventImpl(initialContext,
              ...
              let eventChangeArg = {
                ...
                relatedEvents: internal.buildEventApis(mutatedRelevantEvents,
              ...
              let eventRemoveArg = {
                event: eventApi,
                relatedEvents: internal.buildEventApis(relevantEvents,
                    initialContext, eventInstance),
                revert() {
                  initialContext.dispatch({
                    type: 'MERGE_EVENTS',
              ...
              let addedEventApi = new internal.EventImpl(receivingContext,
      ...
      dragging.autoScroller.isEnabled = options.dragScroll;
      let hitDragging = this.hitDragging = new HitDragging(this.dragging,
          internal.interactionSettingsStore);
  ...
  function computeEventMutation(hit0, hit1, eventInstanceStart, massagers) {
    ...
    let delta = internal.diffDates(date0, date1, hit0.context.dateEnv,
    ...
    constructor(settings) {
      ...
      this.handleDragStart = (ev) => {
        ...
        context.emitter.trigger('eventResizeStart', {
          el: segEl,
          event: new internal.EventImpl(context, eventRange.def,
              eventRange.instance),
          jsEvent: ev.origEvent,
      ...
      this.handleHitUpdate = (hit, isFinal, ev) => {
        ...
        if (mutation) {
          mutatedRelevantEvents = internal.applyMutationToEventStore(
              relevantEvents, context.getCurrentData().eventUiBases, mutation,
              context);
          interaction.mutatedEvents = mutatedRelevantEvents;
          if (!internal.isInteractionValid(interaction, hit.dateProfile,
              context)) {
      ...
      this.handleDragEnd = (ev) => {
        ...
        if (this.validMutation) {
          let updatedEventApi = new internal.EventImpl(context,
              mutatedRelevantEvents.defs[eventDef.defId], eventInstance
                  ? mutatedRelevantEvents.instances[eventInstance.instanceId]
                  : null);
          context.dispatch({
          ...
          context.emitter.trigger('eventResize',
              Object.assign(Object.assign({}, eventChangeArg), {
                el: this.draggingSegEl,
                startDelta: this.validMutation.startDelta
                    || internal.createDuration(0),
                endDelta: this.validMutation.endDelta
                    || internal.createDuration(0),
                jsEvent: ev.origEvent,
                view: context.viewApi
              }));
  ...
  class UnselectAuto {
    constructor(context) {
      ...
      this.onDocumentPointerDown = (pev) => {
        ...
        this.matchesEvent = !!internal.elementClosest(downEl,
            EventDragging.SELECTOR); // interaction started on an event?
      };
  ...
  */
      ...
      this.handleHitUpdate = (hit, isFinal, ev) => {
        ...
        if (hit) {
          ...
          if (this.canDropElOnCalendar(ev.subjectEl, receivingContext)) {
            ...
            interaction.mutatedEvents = internal.eventTupleToStore(
                droppableEvent);
            isInvalid = !internal.isInteractionValid(interaction,
      ...
      this.handleDragEnd = (pev) => {
        ...
        if (receivingContext && droppableEvent) {
          ...
          if (dragMeta.create) {
            ...
            receivingContext.emitter.trigger('eventReceive', {
              event: new internal.EventImpl(receivingContext,
  ...
  function computeEventForDateSpan(dateSpan, dragMeta, context) {
    ...
    let def = internal.parseEventDef(refined, extra, dragMeta.sourceId,
        dateSpan.allDay,
      ...
      this.handlePointerDown = (ev) => {
        ...
        dragging.minDistance =
            minDistance != null ?
                minDistance :
                (ev.isTouch ? 0
                    : internal.BASE_OPTION_DEFAULTS.eventDragMinDistance);
        dragging.delay =
            ev.isTouch ? // TODO: eventually read eventLongPressDelay instead vvv
                (longPressDelay != null ? longPressDelay
                    : internal.BASE_OPTION_DEFAULTS.longPressDelay) :
                0;
      };
      this.handleDragStart = (ev) => {
        if (ev.isTouch &&

...
FullCalendar.DayGrid = (function (exports, core, internal$1, preact) {
  ...
  class TableBlockEvent extends internal$1.BaseComponent {
    render() {
      ...
      return (preact.createElement(internal$1.StandardEvent,
          Object.assign({}, props, {
            elClasses: ['fc-daygrid-event', 'fc-daygrid-block-event',
              'fc-h-event'],
  ...
  class TableListItemEvent extends internal$1.BaseComponent {
    render() {
      ...
      let timeText = internal$1.buildSegTimeText(seg, timeFormat, context, true,
          props.defaultDisplayEventEnd);
      return (preact.createElement(internal$1.EventContainer,
          Object.assign({}, props, {
            elTag: "a",
            elClasses: ['fc-daygrid-event', 'fc-daygrid-dot-event'],
            elAttrs: internal$1.getSegAnchorAttrs(props.seg, context),
  ...
  function renderInnerContent(renderProps) {
    return (preact.createElement(preact.Fragment, null,
        ...
        renderProps.timeText && (preact.createElement("div",
            {className: "fc-event-time"}, renderProps.timeText)),
        preact.createElement("div", {className: "fc-event-title"},
            renderProps.event.title || preact.createElement(preact.Fragment,
                null, "\u00A0"))));
  }
                ...
                return (preact.createElement("div", {
                  ...
                  style: {
                    visibility: isForcedInvisible[instanceId] ? 'hidden' : '',
                        ...
                        TableListItemEvent, Object.assign({
                          seg: seg,
                          isDragging: false,
                          isSelected: instanceId === props.eventSelection,
                          defaultDisplayEventEnd: false
                        }, internal$1.getSegMeta(seg, props.todayRange))))
                    : (preact.createElement(TableBlockEvent, Object.assign({
                      seg: seg,
                      isDragging: false,
                      isResizing: false,
                      isDateSelecting: false,
  ...
  class TableCell extends internal$1.DateComponent {
    ...
    render() {
        ...
        extraRenderProps: props.extraRenderProps
      }, (InnerContent, renderProps) => (preact.createElement("div", {
            ref: props.innerElRef,
            className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner",
            style: {minHeight: props.minHeight}
          },
          props.showWeekNumber && (preact.createElement(
              internal$1.WeekNumberContainer, {
                elTag: "a",
                elClasses: ['fc-daygrid-week-number'],
                elAttrs: internal$1.buildNavLinkAttrs(context, date, 'week'),
                date: date,
                defaultFormat: DEFAULT_WEEK_NUM_FORMAT
              })),
          !renderProps.isDisabled &&
          (props.showDayNumber || internal$1.hasCustomDayCellContent(options)
              || props.forceDayTop) ? (preact.createElement("div",
          ...
          preact.createElement("div",
              ...
              preact.createElement("div", {
                  ...
                  preact.createElement(TableCellMoreLink, {
                    allDayDate: date,
          ...
          preact.createElement("div", {className: "fc-daygrid-day-bg"},
              props.bgContent)))));
    }
  }
  ...
  class DayGridSegHierarchy extends internal$1.SegHierarchy {
    ...
    addSegs(segInputs) {
      ...
      const excludeHidden = (entry) => !this.forceHidden[internal$1.buildEntryKey(
          entry)];
        ...
        if (!forceHidden[touchingEntryId]) {
          if (this.allowReslicing) {
            ...
            const hiddenEntry = Object.assign(Object.assign({}, touchingEntry),
                {
                  span: internal$1.intersectSpans(touchingEntry.span,
                      entry.span)
                });
    ...
    render() {
      ...
      let {
        ...
        moreMarginTops
          ...
          internal$1.sortEventSegs(props.fgEventSegs, options.eventOrder),
      ...
      return (preact.createElement("tr", {ref: this.rootElRef, role: "row"},
          ...
          props.cells.map((cell, col) => {
            ...
            return (preact.createElement(TableCell, {
              key: cell.key,
    ...
    renderFgSegs(col, segPlacements, todayRange, isForcedInvisible, isDragging,
      ...
      if (framePositions) {
        for (let placement of segPlacements) {
          ...
          */
          nodes.push(preact.createElement("div", {
          ...
          }, hasListItemDisplay(seg) ? (preact.createElement(TableListItemEvent,
                  Object.assign({
                    seg: seg,
                    isDragging: isDragging,
                    isSelected: instanceId === eventSelection,
                    defaultDisplayEventEnd: defaultDisplayEventEnd
                  }, internal$1.getSegMeta(seg, todayRange))))
              : (preact.createElement(TableBlockEvent, Object.assign({
                seg: seg,
                isDragging: isDragging,
      ...
      if (!props.forPrint &&
        ...
        if (isExternalSizingChange) {
          ...
          if (frameEls.length) {
            ...
            let newPositionCache = new internal$1.PositionCache(originEl,
                frameEls, true, // isHorizontal
                false);
            if (!state.framePositions || !state.framePositions.similarTo(
                newPositionCache)) {
              this.setState({
                framePositions: new internal$1.PositionCache(originEl, frameEls,
                    true, // isHorizontal
                    false),
              });
            }
  ...
  class TableRows extends internal$1.DateComponent {
    ...
    render() {
      ...
      let cellMinHeight = (rowCnt >= 7 && props.clientWidth) ?
          ...
          null;
      return (preact.createElement(internal$1.NowTimer, {unit: "day"},
          (nowDate, todayRange) => (preact.createElement(preact.Fragment, null,
              props.cells.map((cells, row) => (preact.createElement(TableRow, {
    ...
    // ----------------------------------------------------------------------------------------------------
    prepareHits() {
      this.rowPositions = new internal$1.PositionCache(this.rootEl,
          this.rowRefs.collect().map((rowObj) => rowObj.getCellEls()[0]), // first cell el in each row. TODO: not optimal
          false, true);
      this.colPositions = new internal$1.PositionCache(this.rootEl,
      ...
      return (preact.createElement("div", {
          ...
          preact.createElement("table", {
              ...
              preact.createElement("tbody", {role: "presentation"},
                  preact.createElement(TableRows, {
                    dateProfile: props.dateProfile,
                    cells: props.cells,
  ...
  function getScrollSubjectEl(containerEl, dateProfile) {
    ...
    if (dateProfile.currentRangeUnit.match(/year|month/)) {
      el = containerEl.querySelector(
          `[data-date="${internal$1.formatIsoMonthStr(
              dateProfile.currentDate)}-01"]`);
      // even if view is month-based, first-of-month might be hidden...
    }
    if (!el) {
      el = containerEl.querySelector(`[data-date="${internal$1.formatDayString(
  ...
  class DayTable extends internal$1.DateComponent {
    ...
    render() {
      let {props, context} = this;
      return (preact.createElement(Table, Object.assign({ref: this.tableRef},
  ...
  class DayTableView extends TableView {
    ...
    render() {
      ...
      let bodyContent = (contentArg) => (preact.createElement(DayTable, {
        ref: this.tableRef,
        dateProfile: props.dateProfile,
  ...
  function buildDayTableModel(dateProfile, dateProfileGenerator) {
    let daySeries = new internal$1.DaySeriesModel(dateProfile.renderRange,
        dateProfileGenerator);
    return new internal$1.DayTableModel(daySeries,
  ...
  function buildDayTableRenderRange(props) {
    ...
    if (props.fixedWeekCount) {
      ...
      let lastMonthRenderStart = dateEnv.startOfWeek(
          dateEnv.startOfMonth(internal$1.addDays(currentRange.end, -1)));

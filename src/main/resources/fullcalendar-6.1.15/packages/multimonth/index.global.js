...
(c) 2024 Adam Shaw
*/
FullCalendar.MultiMonth = (function (exports, core, internal$1, internal,
    preact) {
  'use strict';
          ...
          preact.createElement("div", {
              ...
              preact.createElement("table", {
                  ...
                  preact.createElement("thead", {role: "rowgroup"},
                      preact.createElement(internal.DayHeader, {
          ...
          preact.createElement("div", {
              ...
              preact.createElement("table", {
                  ...
                  preact.createElement("tbody", {role: "rowgroup"},
                      preact.createElement(internal$1.TableRows,
  ...
  class MultiMonthView extends internal.DateComponent {
    ...
    render() {
      ...
      return (preact.createElement(internal.ViewContainer, {
        elRef: this.scrollElRef,
        elClasses: rootClassNames,
        viewSpec: context.viewSpec
      }, monthDateProfiles.map((monthDateProfile, i) => {
        const monthStr = internal.formatIsoMonthStr(
            monthDateProfile.currentRange.start);
        return (preact.createElement(SingleMonth, Object.assign({}, props, {
          key: monthStr,
          isoDateStr: monthStr,
    ...
    flushScrollReset() {
      if (this.needsScrollReset &&
        ...
        const monthEl = scrollEl.querySelector(
            `[data-date="${internal.formatIsoMonthStr(currentDate)}"]`);
  ...
  function splitDateProfileByMonth(dateProfileGenerator, dateProfile, dateEnv,
    ...
    while (monthStart.valueOf() < end.valueOf()) {
      ...
      const activeRange = dateProfile.activeRange ?
          internal.intersectRanges(dateProfile.activeRange,
  ...
  // date formatting
  // -------------------------------------------------------------------------------------------------
  const YEAR_MONTH_FORMATTER = internal.createFormatter(
...
})({}, FullCalendar, FullCalendar.DayGrid.Internal, FullCalendar.Internal,
    FullCalendar.Preact);
